...
notes_root = '/home/shared/ards/clean_data1'
...
def run_cross_validation():
  ...
  # grid search
  params = [{'kernal':['rbf'], 'gamma': [1e-3, 1e-4], 'C': [1, 10, 100, 1000]}, {'kernal':['linear'], 'C': [1, 10, 100, 1000]}]

  scores = ['precision', 'recall']

  for score in scores:
      print("Hyperparameter tuning for score %s\n" % score)

      classifier = GridSearchCV(estimator=SVC, fit_params=params, scoring = '%s_macro' % score, cv=num_folds)
